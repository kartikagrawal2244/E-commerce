    ...
    return (
        <div className='bg-[#4B3049] text-center py-[200px]'>
            <div className="max-w-3xl mx-auto px-8">
                ...
                <p className='text-white text-base font-normal '>Seamlessly empower fully researched growth strategies and interoperable internal or “organic” sources credibly innovate granular internal .</p>
